...
```bash
swift run --package-path code/mono/orgs/wrkstrm/public/spm/clis/swift-cli-kit swift-cli-kit random --length 6 --kind ascii
```

Generate a random emoji from curated sets (status, momentum, work, conventions/all):

```bash
swift run --package-path code/mono/orgs/wrkstrm/public/spm/clis/swift-cli-kit swift-cli-kit random \
...
```bash
# In‑place files
swift run --package-path code/mono/orgs/wrkstrm/public/spm/clis/swift-cli-kit swift-cli-kit json format \
...
# Stream format
cat data.json | swift run --package-path code/mono/orgs/wrkstrm/public/spm/clis/swift-cli-kit swift-cli-kit json format --stdin
```

Docs:

- JSON formatter usage: code/mono/orgs/wrkstrm/public/spm/clis/swift-cli-kit/sources/cli-kit/Documentation.docc/JSONFormatter-Usage.md
